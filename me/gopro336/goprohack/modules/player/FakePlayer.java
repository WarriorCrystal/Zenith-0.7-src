...
public class FakePlayer extends Module
{
    ...
    public FakePlayer() {
        super("FakePlayer", new String[] { "Fake" }, "Summons a fake player", "NONE", 14342949, ModuleType.PLAYER);
    }
    ...
    static {
        name = new Value<String>("Name", new String[] { "name" }, "Name of the fake player", "Vonsek");
    }
}
