...
public class ChestSwapModule extends Module
{
    ...
    public ChestSwapModule() {
        super("ElytraToggle", new String[] { "ElytraOneButton" }, "Will attempt to instantly swap your chestplate with an elytra or vice versa, depending on what is already equipped", "NONE", 2415572, ModuleType.PLAYER);
        ...
        this.Curse = new Value<Boolean>("AntiCurse", new String[] { "Curses" }, "Prevents you from equipping armor with curse of binding.", false);
    }
