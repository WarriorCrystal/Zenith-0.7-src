...
public class SelfTrapModule extends Module
{
    ...
    public SelfTrapModule() {
        super("SelfTrap", new String[] { "SelfTrapHole" }, "Automatically places an obsidian over your head, and optionally if you're in a hole", "NONE", 5131167, ModuleType.COMBAT);
                        ...
                        if ((this.hasStack(Blocks.OBSIDIAN) || slot != -1) && this.mc.player.onGround) {
                            ...
                            if (l_Result == BlockInteractionHelper.ValidResult.AlreadyBlockThere && !this.mc.world.getBlockState(this.TrapPos).getMaterial().isReplaceable()) {
                                ...
                                if (l_Result4 == BlockInteractionHelper.PlaceResult.Placed) {
                                    ...
                                    PlayerUtil.PacketFacePitchAndYaw(rotations2[1], rotations2[0]);
                                }
                                this.Finish(lastSlot);
                            }
                        }
