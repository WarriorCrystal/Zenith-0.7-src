...
public class AntiTrapCityModule extends Module
{
    public final Value<Boolean> TrapCheck;
    @EventHandler
    private Listener<EventPlayerMotionUpdate> OnPlayerUpdate;
    
    public AntiTrapCityModule() {
        super("AntiTrapCity", new String[] { "AntiTrap" }, "Automatically places 4 obsidian in the direction your facing to prevent getting crystaled", "NONE", -1, ModuleType.COMBAT);
