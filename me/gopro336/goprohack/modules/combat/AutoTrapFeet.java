...
public class AutoTrapFeet extends Module
{
    ...
    public AutoTrapFeet() {
        super("AutoTrapFeet", new String[] { "AutoTrapFeet" }, "Traps enemies with holes at their feet", "NONE", 5131167, ModuleType.COMBAT);
                ...
                if (this.Target != null) {
                    if (this.IsCurrentTargetTrapped()) {
                        if (this.Toggles.getValue()) {
                            this.toggle();
                            GoproHack.SendMessage(ChatFormatting.LIGHT_PURPLE + "[AutoTrapFeet]: Current target is trapped. Toggling");
                        }
                    }
    ...
    public void onEnable() {
        ...
        if (this.Target != null) {
            GoproHack.SendMessage("[AutoTrapFeet]: Found target " + this.Target.getName());
        }
    }
