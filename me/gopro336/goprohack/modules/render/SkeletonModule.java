...
public class SkeletonModule extends Module
{
    ...
    public SkeletonModule() {
        super("SkelRender", new String[] { "Skelly", "Skellyboi" }, "Renders player entities skeletons", "NONE", -1, ModuleType.RENDER);
        ...
        this.onRenderEvent = new Listener<RenderEvent>(event -> {
            if (this.mc.getRenderManager() != null && this.mc.getRenderManager().options != null) {
                ...
                GL11.glEnable(2903);
                GL11.glDisable(2848);
                SkeletonModule.entities.keySet().removeIf(this::doesntContain);
    ...
    private void drawSkeleton(final RenderEvent event, final EntityPlayer e) {
        ...
        final float[][] entPos = SkeletonModule.entities.get(e);
