...
public class ESPUtil
{
    ...
    public static void RenderCSGO(final ICamera camera, final EntityESPModule ESP, final RenderEvent p_Event) {
        GL11.glPushMatrix();
        double d3;
        double d4;
        double d5;
    ...
    public static void Render(final HoleModes p_Mode, final AxisAlignedBB bb, final float p_Red, final float p_Green, final float p_Blue, final float p_Alpha) {
        switch (p_Mode) {
            case Flat: {
