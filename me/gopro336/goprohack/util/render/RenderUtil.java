...
public final class RenderUtil
{
    ...
    public static float drawStringWithShadow(final String p_Name, final float p_X, final float p_Y, final int p_Color) {
        final HudModule l_Hud = (HudModule)ModuleManager.Get().GetMod(HudModule.class);
        ...
        return GoproHack.GetFontManager().DrawStringWithShadow(p_Name, p_X, p_Y, p_Color);
    }
    ...
    public static float getStringWidth(final String p_Name) {
        ...
        return GoproHack.GetFontManager().GetStringWidth(p_Name);
    }
    ...
    public static float getStringHeight(final String name) {
        ...
        return GoproHack.GetFontManager().GetStringHeight(name);
    }
    
    public static float getStringWatermarkHeight(final String name) {
        final HudModule l_Hud = (HudModule)ModuleManager.Get().GetMod(HudModule.class);
        if (l_Hud != null && !l_Hud.CustomFont.getValue()) {
            return 18.0f;
        }
        return GoproHack.GetFontManager().GetStringWatermarkHeight(name);
    }
