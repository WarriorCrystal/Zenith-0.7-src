...
public class GoproDynamicTexture extends DynamicTexture
{
    private int Height;
    private int Width;
    ...
    public GoproDynamicTexture(final BufferedImage bufferedImage, final int p_Height, final int p_Width) {
        super(bufferedImage);
        this.m_Frame = null;
