...
public class ComponentItemHUD extends ComponentItem
{
    ...
    public ComponentItemHUD(final HudComponentItem p_Mod, final String p_DisplayText, final String p_Description, final int p_Flags, final int p_State, final ComponentItemListener p_Listener, final float p_Width, final float p_Height) {
